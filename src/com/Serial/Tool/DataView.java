...
public class DataView extends Frame{
    ...
    private Label tem=new Label("no data",Label.CENTER);
    private Label hum=new Label("no data",Label.CENTER);
    private Label pa=new Label("no data",Label.CENTER);
    private Label rain=new Label("no data",Label.CENTER);
    private Label win_sp=new Label("no data",Label.CENTER);
    private Label win_dir=new Label("no data",Label.CENTER);
  ...
  //  Image icon = toolKit.getImage("F:\\java.program\\SerialProject\\src\\computer.png");
    /*
     * 构造方法
     */
    public DataView(Client clinet){
    	this.client=clinet;
